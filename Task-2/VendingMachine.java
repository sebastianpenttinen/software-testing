        	...
        	//insertedCoins is tokenized using spaces, eg OE OE OE for 3 Euros
                ...
                while(st.hasMoreElements()) {
                        ...
                        if (coin.equals("CANCEL")) {
                        	//pressing CANCEL when inserting coins aborts the payment and returns the money
                        	System.out.println("You have pressed CANCEL. Current ammount is " + amountPaid + " Euro");
                        	return amountPaid;
                        }
                ...
                //simplification of return amountPaid -price;
                double change = amountPaid -price;
                return change;
        }
        
        
        public Boolean captureMoney(String selection, double price){
                ...
                try {
                        ...
                        if (amount != null) {                   		
                                ...
                                //pressing CANCEL when inserting coins aborts the payment and returns the money
                                if (amount.contains("CANCEL")){//contains instead of equal in order to allow passing strings like "TE CANCEL" from
                        			//returning coins
                        			System.out.println("Returning your sum " + change + " EURO");
                                ...
                                if ( change >= 0.0) {
                                       ...
                                       // User paid the exact amount , deliver drink, , reset amount paid 
                                       System.out.println("DRINK DELIVERED! \n\n");
                                       amountPaid=0;
                                       System.out.println("Thank you for your business, you see again! \n\n\n\n");                                        
                                      return(true);   	
                                }  
                                System.out.println("Type CANCEL to return your coins");
                                } 
                        else {
              ...
              System.out.println("Enter more coin(s) to get your drink.");
               }
